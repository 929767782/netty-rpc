package com.llp.rpc.common.zookeeper;
...
public class CuratorClient {
    ...
    public CuratorClient(String connectString, int timeout) {
        this(connectString, Config.getZookeeperNameSpace(), timeout, timeout);
    }

    public CuratorClient(String connectString) {
        this(connectString, Config.getZookeeperNameSpace(), Integer.parseInt(Config.getZookeeperSessionTimeout()), Integer.parseInt(Config.getZookeeperSessionTimeout()));
    }
